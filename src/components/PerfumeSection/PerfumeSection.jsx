...
function PerfumeSection({
    ...
    // colorButton = "#A68B7D", 
    perfume = "/Lattafa.glb", 
    img1 = "/src/assets/Lattafa/Lattafa_Khamrah.png", 
    img2= "/src/assets/Lattafa/Lattafa_BadeeAlOud.png"}) {
    ...
    return (
        <div className="h-screen w-full mx-auto flex flex-col bg-[radial-gradient(at_45%_75%,#171616_0%,#171616_50%,#4F3528_90%)] px-40 pt-16">
            ...
            <div className="w-11/12">
                <h1 className="w-90 text-9xl flex flex-initial text-white font-roboto(Akshar) mt-2">{name}</h1>
            </div>
                ...
                <div className="w-3/4">
                    ...
                    <div className="flex items-center justify-between w-full gap-6">
                        ...
                        <div className="flex justify-center items-center w-[500px] h-[500px]">
                            <PerfumeScene modelPath={perfume} color="#A68B7D" scale={2.2} />
                        </div>
